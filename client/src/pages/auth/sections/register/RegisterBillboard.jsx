...
export const RegisterBillboard = () => {
      ...
      <div className="relative z-10 p-12 w-full flex flex-col justify-center">
        <div className="max-w-lg">
          ...
          <h1 className="text-4xl font-normal text-text-light mb-6 leading-tight">
            Join Our 
            <span className="text-accent"> Fleet Network</span>
          </h1>
          <p className="text-lg text-text mb-8">
            Get started with comprehensive tracking, fuel management, and maintenance solutions 
            for your truck fleet. Optimize efficiency from day one.
          </p>
